...
//DB config
const connection_url = "mongodb+srv://varunjeett:mAtW3hFdNC6iJ0d1@cluster0.mchrl.mongodb.net/whatsappdb?retryWrites=true&w=majority";
...
//api routes
app.get("/", (req, res) => res.status(200).send("are you with me"));
app.get("/trying", (req, res) => res.status(200).send("are you with trying"));
